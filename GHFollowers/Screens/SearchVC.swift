...
class SearchVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = .systemBackground //dark light mode automatic
    ...
    override func viewWillAppear(_ animated: Bool) { //everytime when view appear
...
extension SearchVC: UITextFieldDelegate { //Listening tap return
